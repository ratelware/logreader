...
IF(${USE_BOOST})
    SET(Boost_VERSION "1.65.1" CACHE STRING "Required version of Boost to use")
    SET(Boost_REQUIRED_LIBRARIES unit_test_framework program_options filesystem regex CACHE LIST "Used Boost libraries")
